        ...
        <header class="hero">
            <div class="hero-copy reveal">
                ...
                <div class="hero-actions">
                    <button class="action action-primary" data-run-mode="live">Uruchom sandbox</button>
                </div>
            </div>

            <aside class="hero-panel reveal">
                <p class="panel-label">Dlaczego ta warstwa istnieje</p>
                <p class="panel-copy">Projekt zaczął się jako pojedynczy skrypt CLI. Warstwa prezentacji zamienia go w czytelny przepływ integracyjny — od payloadu żądania po zlecenie odbioru kuriera.</p>
        ...
        <main class="layout">
            <section class="story">
                <div class="section-head reveal">
                    ...
                    <h2>Techniczna integracja w czytelnym przepływie</h2>
                </div>
            ...
            <section class="console reveal">
                <div class="console-head">
                    <div>
                        <p class="eyebrow">Interaktywny runner</p>
                        <h2>Podgląd payloadu i odpowiedzi API</h2>
                    </div>
                    <p class="console-badge" id="run-mode-label">Sandbox</p>
                </div>
                ...
                <form id="demo-form" class="demo-form">
                    ...
                    <fieldset class="form-section">
                        <legend class="form-section__legend">Odbiorca</legend>
                        <div class="field-row">
                            <div class="field-group">
                                <label for="receiver_first_name">Imie</label>
                        ...
                        <div class="field-row">
                            ...
                            <div class="field-group">
                                <label for="receiver_post_code">Kod pocztowy</label>
                                <input
                    ...
                    <fieldset class="form-section">
                        <legend class="form-section__legend">Nadawca</legend>
                        <div class="field-row">
                            <div class="field-group">
                            ...
                            <div class="field-group">
                                <label for="sender_post_code">Kod pocztowy</label>
                                <input
                                    id="sender_post_code"
                    ...
                    <fieldset class="form-section">
                        <legend class="form-section__legend">Przesylka i odbior</legend>
                        <div class="field-row">
                            <div class="field-group">
                    ...
                    <p class="form-note">
                        Kody pocztowe akceptują format <strong>00-000</strong>. Wpisane <strong>12345</strong> lub <strong>12 345</strong> zostanie automatycznie znormalizowane do <strong>12-345</strong>.
                    </p>
                </form>

                <div class="runner-actions">
                    <button class="action action-primary" data-run-mode="live" data-form-submit>Wyślij do sandboxa</button>
                </div>
                ...
                <div class="output-grid">
                    ...
                    <div class="payload-panel">
                        <div class="panel-head">
                            ...
                            <p>Wybrany krok pokazuje żądanie i odpowiedź w JSON.</p>
                        </div>
                        <pre id="payload-view" class="payload-view"><code>Kliknij „Uruchom sandbox", aby zobaczyć przepływ.</code></pre>
                    </div>
                </div>
            </section>
        </main>
